...
🎨 Hunting for new coding passion projects to bring to life<br>💭 Currently developing a program to manage and visualize data at traffic lights using YOLO object detection to track cars and also monitor speeds!</br>
