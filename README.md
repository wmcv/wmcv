...
🎨 Hunting for new coding passion projects to bring to life<br>💭 Currently developing a program to manage and visualize data at traffic lights using YOLO object detection to track and monitor car speeds!</br>
