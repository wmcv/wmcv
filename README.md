...
🎨 Hunting for new coding passion projects to bring to life<br>💭 Currently developing a web application using React to create a dynamic and responsive user interface to help users view popular stock options!</br>
